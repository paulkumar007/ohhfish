...
class Customer {
	...
	public function login($email, $password, $override = false) {
		...
		if ($customer_query->num_rows) {
			...
			if(isset($this->customer_id) && $this->customer_id > 0){
	...
	public function registerUser($mobile){
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer SET language_id = '" . (int)$this->config->get('config_language_id') . "', ip = '" . $this->db->escape($this->request->server['REMOTE_ADDR']) . "', telephone = '".$this->db->escape($mobile)."', customer_group_id = '1', status = '1', approved = '1', date_added = NOW() ");
