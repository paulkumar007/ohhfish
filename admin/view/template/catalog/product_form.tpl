        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				  ...
				  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-recipe<?php echo $language['language_id']; ?>"><?php echo $entry_recipe; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][recipe]" placeholder="<?php echo $entry_recipe; ?>" id="input-recipe<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['recipe'] : ''; ?></textarea>
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-nutrition<?php echo $language['language_id']; ?>"><?php echo $entry_nutrition; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][nutrition]" placeholder="<?php echo $entry_nutrition; ?>" id="input-nutrition<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['nutrition'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-data">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-approx"><span data-toggle="tooltip" title="<?php echo $help_approx; ?>"><?php echo $entry_approx; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="approx" value="<?php echo $approx; ?>" placeholder="<?php echo $entry_approx; ?>" id="input-approx" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($best_seller) { ?>
                    <input type="radio" name="best_seller" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                  ...
                  <label class="radio-inline">
                    <?php if (!$best_seller) { ?>
                    <input type="radio" name="best_seller" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <td class="text-right"><?php echo $entry_caption; ?></td>
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
					  ...
					  <td class="text-right"><input type="text" name="product_image[<?php echo $image_row; ?>][caption]" value="<?php echo $product_image['caption']; ?>" placeholder="<?php echo $entry_caption; ?>" class="form-control" /></td>
...
function addImage() {
	...
	html += '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][caption]" value="" placeholder="<?php echo $entry_caption; ?>" class="form-control" /></td>';
