            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.total') { ?>
                    ...
                    <?php } ?></td>					<td class="text-left">Ship Date</td>					<td class="text-left">Ship Time</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $order['total']; ?></td>                  <td class="text-right"><?php echo $order['ship_date']; ?></td>                  <td class="text-right"><?php echo $order['ship_time']; ?></td>
