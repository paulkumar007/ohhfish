                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <td class="text-right"><?php echo $column_quantity; ?></td>                      <td class="text-right">Ship Date</td>                      <td class="text-right">Ship Time</td>
                  ...
                  <tbody id="cart">
                    ...
                    <tr>
                      ...
                      <td class="text-right"><?php echo $order_product['quantity']; ?>
                        <input type="hidden" name="product[<?php echo $product_row; ?>][quantity]" value="<?php echo $order_product['quantity']; ?>" /></td>					<td class="text-left"><?php echo $order_product['ship_date']; ?></td>					<td class="text-left"><?php echo $order_product['ship_time']; ?></td>
