...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {			$ship_date = '';			$ship_time = '';			$products = $this->model_sale_order->getOrderProducts($result['order_id']);			if($products){				foreach ($products as $product) {					$ship_date = $product['ship_date'];					$ship_time = $product['ship_time'];					break;				}			}			
			$data['orders'][] = array(
				...
				'shipping_code' => $result['shipping_code'],				'ship_date' => $ship_date,				'ship_time' => $ship_time,
		...
		if (!empty($order_info)) {
			...
			foreach ($products as $product) {
				$data['order_products'][] = array(
					...
					'name'       => $product['name'],
					'model'      => $product['model'],					'ship_date'      => $product['ship_date'],					'ship_time'      => $product['ship_time'],
