...
class ControllerCatalogCity extends Controller {
	...
	protected function getList() {
		...
		$data['sort_status'] = $this->url->link('catalog/city', 'token=' . $this->session->data['token'] . '&sort=r.status' . $url, true);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['pincodes'])) {
			$data['pincodes'] = $this->request->post['pincodes'];
		} elseif (!empty($city_info)) {
			$data['pincodes'] = $city_info['pincodes'];
		} else {
			$data['pincodes'] = '';
		}
