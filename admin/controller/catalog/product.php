...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_recipe'] = $this->language->get('entry_recipe');
		$data['entry_nutrition'] = $this->language->get('entry_nutrition');
		...
		$data['entry_approx'] = $this->language->get('entry_approx');
		...
		$data['help_approx'] = $this->language->get('help_approx');
		...
		if (isset($this->request->post['approx'])) {
			$data['approx'] = $this->request->post['approx'];
		} elseif (!empty($product_info)) {
