...
<div class="container">
<div class="row">
	<?php if ($accept_return != 'yes') { ?>
	<br/><div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> Sorry! Your 30 mins cancelation time is over. So, You cannot return the item now!</div>
	<?php } ?>
