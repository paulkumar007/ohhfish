        ...
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <td class="text-right">Ship Date</td>
              <td class="text-right">Ship Time</td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><?php echo $product['ship_date']; ?></td>
              <td class="text-right"><?php echo $product['ship_time']; ?></td>
